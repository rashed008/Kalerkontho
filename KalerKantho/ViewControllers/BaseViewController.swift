...
class BaseViewController: UIViewController, SlideMenuDelegate {
    ...
    func setCurretDate() {
        ...
        dateFormatter.locale = NSLocale(localeIdentifier: "bn_BD")
        dateFormatter.dateFormat = "EEEE dd MMMM yyyy"
        print(dateFormatter.stringFromDate(NSDate()))
        
        for view in (self.navigationController?.view.subviews)! {
            if view.isKindOfClass(CustomNavView) {
                for newV in view.subviews {
                    if newV.isKindOfClass(UILabel) {
                        let lbl  = newV as! UILabel
                        lbl.text = dateFormatter.stringFromDate(NSDate())
...
//            print("default\n", terminator: "")
    ...
    func onSlideMenuButtonPressed(sender : UIButton){
        ...
        let menuVC : MenuVC = self.storyboard!.instantiateViewControllerWithIdentifier("MenuVC") as! MenuVC
